      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-24 md:py-32">
        ...
        <div className="grid md:grid-cols-[0.85fr_1.15fr] gap-14 md:gap-16">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 rounded-full border border-line-soft flex items-center justify-center text-dim hover:text-gold hover:border-gold transition-colors"
                aria-label="LinkedIn"
              >
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-7">
            ...
            <button
              type="submit"
              className="self-start inline-flex items-center gap-2 bg-gold text-ink font-head text-xs tracking-[0.2em] uppercase px-8 py-3.5 rounded-sm hover:bg-gold-soft transition-colors mt-2"
            >
              {sent ? 'Opening mail…' : 'Send'} <Send size={14} />
            </button>
          </form>
        </div>
  ...
  return (
    <label className="flex flex-col gap-2">
      ...
      <Comp
        ...
        className="bg-transparent border-b border-line-soft focus:border-gold outline-none py-2 text-paper text-sm placeholder:text-mute transition-colors resize-none"
      />
    </label>
  );
}
