        ...
        <div className="grid md:grid-cols-[0.85fr_1.15fr] gap-12 md:gap-16 items-start">
          ...
          <div className="fade-up" style={{ animationDelay: '0.1s' }}>
            ...
            <h2 className="font-head text-3xl md:text-4xl lg:text-[42px] leading-[1.2] text-dim mb-8">
              Hey, I'm <span className="text-paper font-bold">Jeshiko</span> — I build{' '}
              <span className="text-paper font-bold">full-stack web applications</span> with clean
              architecture, and I'm growing into{' '}
              <span className="text-paper font-bold">cloud infrastructure</span> that gets them into
              production.
            </h2>

            <p className="text-dim text-sm md:text-[15px] leading-relaxed mb-10 max-w-md">
              Recent Computer Science Engineering graduate focused on Python, Django, and JavaScript —
              with hands-on exposure to AWS, CI/CD pipelines, and Infrastructure as Code. I care about
              code that ships, not just code that runs on localhost.
            </p>
